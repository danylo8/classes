...
- A planner/checklist (assignments + exams, auto-populated, check things off,
  add your own tasks) — saved in your browser via `localStorage`
...
4. Drag in all four files from this folder: `index.html`, `style.css`,
   `app.js`, `data.js`. Commit the upload.
